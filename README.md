...
## Files
- `index.html`, `how-it-works.html`, `vendor-savings.html`, `scorecard.html`, `contact.html`
- `styles.css` — full design system (navy #10243E, clay #B4552F, warm paper #FAF8F4; Archivo + IBM Plex Mono). Includes print styles for the scorecard.
